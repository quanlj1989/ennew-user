...
/**
 * DTO:EntCateCertApply
 * 
 * @author gencode
 * @date 2018-3-30
 */
public class EntCateCertApplyDTO implements Serializable {
	
	private static final long serialVersionUID = -6001855772604448174L;
	...
	// Constructor
	public EntCateCertApplyDTO() {
	}

	/**
	 * full Constructor
	 */
	public EntCateCertApplyDTO(Long certApplyDetailId, Long applyId, String categoryNamePath, String categoryIdPath, Integer categoryId, Integer certType, Integer limitType, Date certValidStartDate, Date certValidEndDate) {
	...
	public String toString() {
		return "EntCateCertApplyDTO [" + "certApplyDetailId=" + certApplyDetailId + ", applyId=" + applyId + ", categoryNamePath=" + categoryNamePath + ", categoryIdPath=" + categoryIdPath + ", categoryId=" + categoryId + ", certType=" + certType + ", limitType=" + limitType + ", certValidStartDate=" + certValidStartDate + ", certValidEndDate=" + certValidEndDate +  "]";
	}
}
