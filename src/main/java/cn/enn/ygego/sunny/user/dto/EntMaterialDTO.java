 ...
 * @date 2018-3-30
 */
public class EntMaterialDTO implements Serializable {
	
	private static final long serialVersionUID = 314142564155741223L;
	...
	// Constructor
	public EntMaterialDTO() {
	}

	/**
	 * full Constructor
	 */
	public EntMaterialDTO(Long entMaterialId, Long entCateId, Long memberId, Long materialId, Long categoryId, String materialName, String attrNameSerial) {
	...
	public String toString() {
		return "EntMaterialDTO [" + "entMaterialId=" + entMaterialId + ", entCateId=" + entCateId + ", memberId=" + memberId + ", materialId=" + materialId + ", categoryId=" + categoryId + ", materialName=" + materialName + ", attrNameSerial=" + attrNameSerial +  "]";
	}
}
