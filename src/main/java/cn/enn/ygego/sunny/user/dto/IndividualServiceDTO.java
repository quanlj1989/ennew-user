...
/**
 * DTO:IndividualService
 * 
 * @author gencode
 * @date 2018-3-19
 */
public class IndividualServiceDTO implements Serializable {
	
	private static final long serialVersionUID = -8955243952604912904L;
	...
	// Constructor
	public IndividualServiceDTO() {
	}

	/**
	 * full Constructor
	 */
	public IndividualServiceDTO(Long serviceId, Long memberId, Integer serviceType, Integer status, Date createTime, Long createAcctId, String createName, Date auditTime, String approveDesc, Long approveAcctId, Long approveMemberId, String approveName) {
