...
public class EntDomainPermitApply implements Serializable {
	...
	// Constructor
	public EntDomainPermitApply() {
	}

	/**
	 * full Constructor
	 */
	public EntDomainPermitApply(Long domainApplyId, Long channelApplyId, Long memberId, Long domainId, Date createTime, Long createAcctId, String createName) {
	...
	public String toString() {
		return "EntDomainPermitApply [" + "domainApplyId=" + domainApplyId+ ", channelApplyId=" + channelApplyId+ ", memberId=" + memberId+ ", domainId=" + domainId+ ", createTime=" + createTime+ ", createAcctId=" + createAcctId+ ", createName=" + createName+  "]";
	}
}
