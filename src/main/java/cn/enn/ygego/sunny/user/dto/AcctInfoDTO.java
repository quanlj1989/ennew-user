 ...
 * @date 2018-3-19
 */
public class AcctInfoDTO implements Serializable {
	 ...
	 * full Constructor
	 */
	public AcctInfoDTO(Long acctId, Long entId, String loginSource, String acctName, String password, String acctCode, Integer acctState, String name, String dept, String mobileNum, String email, Date registerTime, Date updateTime, Date lastLoginTime, Integer isDelete) {
		this.acctId = acctId;
		this.entId = entId;
