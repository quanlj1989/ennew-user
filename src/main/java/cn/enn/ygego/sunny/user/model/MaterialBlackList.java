...
/**
 * entity:MaterialBlackList
 * 
 * @author gencode
 */
public class MaterialBlackList implements Serializable {
	
	private static final long serialVersionUID = -947348181186298774L;
	...
	private Integer	buyerMemberId;		 /* 采购商会员ID */ 
	...
	// Constructor
	public MaterialBlackList() {
	}

	/**
	 * full Constructor
	 */
	public MaterialBlackList(Long listId, Integer categoryId, String categoryNamePath, String categoryIdPath, Long materialId, String materialName, String attrIdSerial, String attrNameSerial, Integer listStatus, Integer buyerMemberId, String buyerName, Integer buyerSettlementType, Date createTime, Long createAcctId, String createName) {
		this.listId = listId;
