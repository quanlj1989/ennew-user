 ...
 * @author gencode
 */
public class AcctOperLog implements Serializable {
	
	private static final long serialVersionUID = -8106551040530906165L;
	 ...
	 * full Constructor
	 */
	public AcctOperLog(Long logId, String logCode, String ipAddr, Integer operType, Integer operResult, String operDetail, Date operTime, Long operMemberId, Long operAcctId, String operPersonName, Long superMemberId, Long superAcctId, String superAcctName) {
		this.logId = logId;
	...
	public String toString() {
		return "AcctOperLog [" + "logId=" + logId+ ", logCode=" + logCode+ ", ipAddr=" + ipAddr+ ", operType=" + operType+ ", operResult=" + operResult+ ", operDetail=" + operDetail+ ", operTime=" + operTime+ ", operMemberId=" + operMemberId+ ", operAcctId=" + operAcctId+ ", operPersonName=" + operPersonName+ ", superMemberId=" + superMemberId+ ", superAcctId=" + superAcctId+ ", superAcctName=" + superAcctName+  "]";
	}
}
