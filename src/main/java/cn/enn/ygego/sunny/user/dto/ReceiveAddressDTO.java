...
public class ReceiveAddressDTO implements Serializable {
	...
	private static final long serialVersionUID = -7860087299192378393L;
	 ...
	 * full Constructor
	 */
	public ReceiveAddressDTO(Long receiveAddressId, Long memberId, Long areaId, String areaIdFullPath, String areaNameFullPath, String addressDetail, String contact, String contactTel, String fixedPhone, Integer isDefaultReceiveAddr, Date createTime, Long createMemberId, Long createAcctId, String createName) {
