...
/**
 * entity:IndividualServiceApply
 * 
 * @author gencode
 */
public class IndividualServiceApply implements Serializable {
	
	private static final long serialVersionUID = 4232851554361821982L;
	...
	// Constructor
	public IndividualServiceApply() {
	}

	/**
	 * full Constructor
	 */
	public IndividualServiceApply(Long serviceApplyId, Long memberId, Integer serviceType, Integer status, Date createTime, Long createMemberId, Long createAcctId, String createName, Date auditTime, String approveDesc, Long approveAcctId, Long approveMemberId, String approveName) {
