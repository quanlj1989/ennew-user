 ...
 * 作者姓名           修改时间           版本号              描述
*/
public class MarketDiscountCate implements Serializable {
	...
	// Constructor
	public MarketDiscountCate() {
	}

	/**
	 * full Constructor
	 */
	public MarketDiscountCate(Long discountId, Long marketId, Long categoryId, String categoryName, String categoryNamePath, String categoryIdPath, Date effDate, Date expDate, Integer standardPremiumRates, Integer discountNum, Integer actualCharge, Integer status, Date createTime, Long createMemberId, Long createAcctId, String createName, Date modTime) {
	...
	public String toString() {
		return "MarketDiscountCate [" + "discountId=" + discountId + ", marketId=" + marketId + ", categoryId=" + categoryId + ", categoryName=" + categoryName + ", categoryNamePath=" + categoryNamePath + ", categoryIdPath=" + categoryIdPath + ", effDate=" + effDate + ", expDate=" + expDate + ", standardPremiumRates=" + standardPremiumRates + ", discountNum=" + discountNum + ", actualCharge=" + actualCharge + ", status=" + status + ", createTime=" + createTime + ", createMemberId=" + createMemberId + ", createAcctId=" + createAcctId + ", createName=" + createName + ", modTime=" + modTime +  "]";
	}
}
