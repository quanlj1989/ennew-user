...
/**
 * entity:EntCateCertInfo
 * 
 * @author gencode
 */
public class EntCateCertInfo implements Serializable {
	
	private static final long serialVersionUID = 5473688932016274447L;
	...
	// Constructor
	public EntCateCertInfo() {
	}

	/**
	 * full Constructor
	 */
	public EntCateCertInfo(Long certInfoId, Long memberId, String categoryNamePath, String categoryIdPath, Integer categoryId, Integer certType, Integer limitType, Date certValidStartDate, Date certValidEndDate, Date createTime, Long createAcctId, String createName) {
