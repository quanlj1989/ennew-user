...
public class ThirdLoginConfigDTO implements Serializable {
	...
	private static final long serialVersionUID = 4014595956465697332L;
	...
	// Constructor
	public ThirdLoginConfigDTO() {
	}

	/**
	 * full Constructor
	 */
	public ThirdLoginConfigDTO(Long configId, String companyName, String companyShortName, String companyIconUri, String redirectUri, String appId, String appSecretKey, String loginUri, String getTokenUri, Integer status, Integer sort, Date createTime, Long createMemberId, Long createAcctId, String createName) {
	...
	public String toString() {
		return "ThirdLoginConfigDTO [" + "configId=" + configId + ", companyName=" + companyName + ", companyShortName=" + companyShortName + ", companyIconUri=" + companyIconUri + ", redirectUri=" + redirectUri + ", appId=" + appId + ", appSecretKey=" + appSecretKey + ", loginUri=" + loginUri + ", getTokenUri=" + getTokenUri + ", status=" + status + ", sort=" + sort + ", createTime=" + createTime + ", createMemberId=" + createMemberId + ", createAcctId=" + createAcctId + ", createName=" + createName +  "]";
	}
}
