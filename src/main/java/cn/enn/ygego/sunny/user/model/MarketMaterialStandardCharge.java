 ...
 * 作者姓名           修改时间           版本号              描述
*/
public class MarketMaterialStandardCharge implements Serializable {
	...
	// Constructor
	public MarketMaterialStandardCharge() {
	}

	/**
	 * full Constructor
	 */
	public MarketMaterialStandardCharge(Long chargeId, Long marketId, Long categoryId, String categoryName, String categoryNamePath, String categoryIdPath, Long materialId, String materialName, String materialCode, String attrNameSerial, Integer standardPremiumRates, Integer status, String memo, Date createTime, Long createMemberId, Long createAcctId, String createName, Date modTime) {
	...
	public String toString() {
		return "MarketMaterialStandardCharge [" + "chargeId=" + chargeId + ", marketId=" + marketId + ", categoryId=" + categoryId + ", categoryName=" + categoryName + ", categoryNamePath=" + categoryNamePath + ", categoryIdPath=" + categoryIdPath + ", materialId=" + materialId + ", materialName=" + materialName + ", materialCode=" + materialCode + ", attrNameSerial=" + attrNameSerial + ", standardPremiumRates=" + standardPremiumRates + ", status=" + status + ", memo=" + memo + ", createTime=" + createTime + ", createMemberId=" + createMemberId + ", createAcctId=" + createAcctId + ", createName=" + createName + ", modTime=" + modTime +  "]";
	}
}
