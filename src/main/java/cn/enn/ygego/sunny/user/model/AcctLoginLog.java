...
public class AcctLoginLog implements Serializable {
	...
	private static final long serialVersionUID = 3017007455450208544L;
	 ...
	 * full Constructor
	 */
	public AcctLoginLog(Long logId, String logCode, Date loginTime, String ipAddr, Integer loginType, Integer loginResult, String loginDetail, Long operMemberId, Long operAcctId, String operPersonName, Long superMemberId, Long superAcctId, String superAcctName) {
		this.logId = logId;
	...
	public String toString() {
		return "AcctLoginLog [" + "logId=" + logId+ ", logCode=" + logCode+ ", loginTime=" + loginTime+ ", ipAddr=" + ipAddr+ ", loginType=" + loginType+ ", loginResult=" + loginResult+ ", loginDetail=" + loginDetail+ ", operMemberId=" + operMemberId+ ", operAcctId=" + operAcctId+ ", operPersonName=" + operPersonName+ ", superMemberId=" + superMemberId+ ", superAcctId=" + superAcctId+ ", superAcctName=" + superAcctName+  "]";
	}
}
