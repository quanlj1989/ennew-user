...
public class ProdInfo implements Serializable {
	...
	private static final long serialVersionUID = 2548882079266903974L;
	 ...
	 * full Constructor
	 */
	public ProdInfo(Long prodId, Long materialId, Long brandId, Long producerMemberId, String producerName, Integer qualityTraceType, Date createTime, Long createAcctId) {
		this.prodId = prodId;
	...
	public String toString() {
		return "ProdInfo [" + "prodId=" + prodId+ ", materialId=" + materialId+ ", brandId=" + brandId+ ", producerMemberId=" + producerMemberId+ ", producerName=" + producerName+ ", qualityTraceType=" + qualityTraceType+ ", createTime=" + createTime+ ", createAcctId=" + createAcctId+  "]";
	}
}
