 ...
 * @date 2018-3-19
 */
public class FunctionManageDTO implements Serializable {
	
	private static final long serialVersionUID = 4256954074149749410L;
	...
	// Constructor
	public FunctionManageDTO() {
	}

	/**
	 * full Constructor
	 */
	public FunctionManageDTO(Long functionId, Long appId, String functionCode, String functionTitle, Integer functionState, String functionDesc, Integer operStatistics, String idFullPath, String titleFullPath, Integer isLastLevel, Long parentApplicationId, Date createTime, Date updateTime, Integer isDelete) {
	...
	public String toString() {
		return "FunctionManageDTO [" + "functionId=" + functionId + ", appId=" + appId + ", functionCode=" + functionCode + ", functionTitle=" + functionTitle + ", functionState=" + functionState + ", functionDesc=" + functionDesc + ", operStatistics=" + operStatistics + ", idFullPath=" + idFullPath + ", titleFullPath=" + titleFullPath + ", isLastLevel=" + isLastLevel + ", parentApplicationId=" + parentApplicationId + ", createTime=" + createTime + ", updateTime=" + updateTime + ", isDelete=" + isDelete +  "]";
	}
}
