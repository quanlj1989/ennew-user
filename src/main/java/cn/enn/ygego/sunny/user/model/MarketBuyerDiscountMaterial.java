 ...
 * 作者姓名           修改时间           版本号              描述
*/
public class MarketBuyerDiscountMaterial implements Serializable {
	...
	// Constructor
	public MarketBuyerDiscountMaterial() {
	}

	/**
	 * full Constructor
	 */
	public MarketBuyerDiscountMaterial(Long discountId, Long discountBuyerId, Long categoryId, String categoryName, String categoryNamePath, String categoryIdPath, Long materialId, String materialName, String materialCode, String attrNameSerial, Integer standardPremiumRates, Integer discountNum, Integer actualCharge, Integer status, String memo, Date createTime, Long createMemberId, Long createAcctId, String createName, Date modTime) {
	...
	public String toString() {
		return "MarketBuyerDiscountMaterial [" + "discountId=" + discountId + ", discountBuyerId=" + discountBuyerId + ", categoryId=" + categoryId + ", categoryName=" + categoryName + ", categoryNamePath=" + categoryNamePath + ", categoryIdPath=" + categoryIdPath + ", materialId=" + materialId + ", materialName=" + materialName + ", materialCode=" + materialCode + ", attrNameSerial=" + attrNameSerial + ", standardPremiumRates=" + standardPremiumRates + ", discountNum=" + discountNum + ", actualCharge=" + actualCharge + ", status=" + status + ", memo=" + memo + ", createTime=" + createTime + ", createMemberId=" + createMemberId + ", createAcctId=" + createAcctId + ", createName=" + createName + ", modTime=" + modTime +  "]";
	}
}
