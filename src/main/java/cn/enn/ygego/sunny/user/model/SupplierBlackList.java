...
/**
 * entity:SupplierBlackList
 * 
 * @author gencode
 */
public class SupplierBlackList implements Serializable {
	
	private static final long serialVersionUID = 4760352108680259037L;
	 ...
	 * full Constructor
	 */
	public SupplierBlackList(Long supplierListId, Long listId, Integer supplierMemberId, String supplierName, Integer listStatus, Date createTime, Long createAcctId, String createName) {
	...
	public String toString() {
		return "SupplierBlackList [" + "supplierListId=" + supplierListId+ ", listId=" + listId+ ", supplierMemberId=" + supplierMemberId+ ", supplierName=" + supplierName+ ", listStatus=" + listStatus+ ", createTime=" + createTime+ ", createAcctId=" + createAcctId+ ", createName=" + createName+  "]";
	}
}
