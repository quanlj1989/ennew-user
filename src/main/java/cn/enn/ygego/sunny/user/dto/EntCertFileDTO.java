 ...
 * @date 2018-3-30
 */
public class EntCertFileDTO implements Serializable {
	
	private static final long serialVersionUID = -3348361663693649079L;
	...
	// Constructor
	public EntCertFileDTO() {
	}

	/**
	 * full Constructor
	 */
	public EntCertFileDTO(Long certFileId, Long certInfoId, Integer certFileType, Integer sortNum, Long fileSize, String fileUrl) {
	...
	public String toString() {
		return "EntCertFileDTO [" + "certFileId=" + certFileId + ", certInfoId=" + certInfoId + ", certFileType=" + certFileType + ", sortNum=" + sortNum + ", fileSize=" + fileSize + ", fileUrl=" + fileUrl +  "]";
	}
}
