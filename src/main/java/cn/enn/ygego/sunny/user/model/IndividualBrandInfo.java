...
/**
 * entity:IndividualBrandInfo
 * 
 * @author gencode
 */
public class IndividualBrandInfo implements Serializable {
	
	private static final long serialVersionUID = 4201505290646260395L;
	...
	// Constructor
	public IndividualBrandInfo() {
	}

	/**
	 * full Constructor
	 */
	public IndividualBrandInfo(Long individualBrandId, Long memberId, Integer categoryId, String categoryNamePath, String categoryIdPath, Integer brandId, String brandName, String brandDesc, Date createTime, Date modTime, Long createAcctId, String createName) {
	...
	public String toString() {
		return "IndividualBrandInfo [" + "individualBrandId=" + individualBrandId+ ", memberId=" + memberId+ ", categoryId=" + categoryId+ ", categoryNamePath=" + categoryNamePath+ ", categoryIdPath=" + categoryIdPath+ ", brandId=" + brandId+ ", brandName=" + brandName+ ", brandDesc=" + brandDesc+ ", createTime=" + createTime+ ", modTime=" + modTime+ ", createAcctId=" + createAcctId+ ", createName=" + createName+  "]";
	}
}
