 ...
 * @date 2018-3-30
 */
public class EntSetDTO implements Serializable {
	
	private static final long serialVersionUID = 5099740269468127722L;
	 ...
	 * full Constructor
	 */
	public EntSetDTO(Long setId, Long memberId, String blackWhiteListSet, String agreementPriceId, Integer cateMateId, Long pareMemberId, Integer applyType, Integer status, Date createTime, Long createAcctId, String createName) {
		this.setId = setId;
	...
	public String toString() {
		return "EntSetDTO [" + "setId=" + setId + ", memberId=" + memberId + ", blackWhiteListSet=" + blackWhiteListSet + ", agreementPriceId=" + agreementPriceId + ", cateMateId=" + cateMateId + ", pareMemberId=" + pareMemberId + ", applyType=" + applyType + ", status=" + status + ", createTime=" + createTime + ", createAcctId=" + createAcctId + ", createName=" + createName +  "]";
	}
}
