...
public class DataPriv implements Serializable {
	...
	private static final long serialVersionUID = -6058633629995586820L;
	 ...
	 * full Constructor
	 */
	public DataPriv(Long privId, Long relaId, Integer privType, Long linkDataId, Long functionId, Long operId, String privCode, String privTitle, String dataLink, Integer contentType, String privContent, String valueRange, String dataPriTitle, String dataRange, Date createTime, Date updateTime, Integer isDelete) {
		this.privId = privId;
		this.relaId = relaId;
	...
	public String toString() {
		return "DataPriv [" + "privId=" + privId+ ", relaId=" + relaId+ ", privType=" + privType+ ", linkDataId=" + linkDataId+ ", functionId=" + functionId+ ", operId=" + operId+ ", privCode=" + privCode+ ", privTitle=" + privTitle+ ", dataLink=" + dataLink+ ", contentType=" + contentType+ ", privContent=" + privContent+ ", valueRange=" + valueRange+ ", dataPriTitle=" + dataPriTitle+ ", dataRange=" + dataRange+ ", createTime=" + createTime+ ", updateTime=" + updateTime+ ", isDelete=" + isDelete+  "]";
	}
}
