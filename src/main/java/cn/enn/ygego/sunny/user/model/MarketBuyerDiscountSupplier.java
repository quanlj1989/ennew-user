 ...
 * 作者姓名           修改时间           版本号              描述
*/
public class MarketBuyerDiscountSupplier implements Serializable {
	...
	// Constructor
	public MarketBuyerDiscountSupplier() {
	}

	/**
	 * full Constructor
	 */
	public MarketBuyerDiscountSupplier(Long discountId, Long discountBuyerId, Long categoryId, String categoryName, String categoryNamePath, String categoryIdPath, Date effDate, Date expDate, Integer standardPremiumRates, Integer discountNum, Integer actualCharge, Integer status, Date createTime, Long createMemberId, Long createAcctId, String createName, Date modTime) {
	...
	public String toString() {
		return "MarketBuyerDiscountSupplier [" + "discountId=" + discountId + ", discountBuyerId=" + discountBuyerId + ", categoryId=" + categoryId + ", categoryName=" + categoryName + ", categoryNamePath=" + categoryNamePath + ", categoryIdPath=" + categoryIdPath + ", effDate=" + effDate + ", expDate=" + expDate + ", standardPremiumRates=" + standardPremiumRates + ", discountNum=" + discountNum + ", actualCharge=" + actualCharge + ", status=" + status + ", createTime=" + createTime + ", createMemberId=" + createMemberId + ", createAcctId=" + createAcctId + ", createName=" + createName + ", modTime=" + modTime +  "]";
	}
}
