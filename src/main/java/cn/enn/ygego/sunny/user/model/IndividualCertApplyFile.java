...
/**
 * entity:IndividualCertApplyFile
 * 
 * @author gencode
 */
public class IndividualCertApplyFile implements Serializable {
	
	private static final long serialVersionUID = -5686571290699591889L;
	...
	// Constructor
	public IndividualCertApplyFile() {
	}

	/**
	 * full Constructor
	 */
	public IndividualCertApplyFile(Long certApplyFileId, Long certApplyDetailId, Integer certFileType, Long fileSize, String fileUrl, Date createTime) {
	...
	public String toString() {
		return "IndividualCertApplyFile [" + "certApplyFileId=" + certApplyFileId+ ", certApplyDetailId=" + certApplyDetailId+ ", certFileType=" + certFileType+ ", fileSize=" + fileSize+ ", fileUrl=" + fileUrl+ ", createTime=" + createTime+  "]";
	}
}
