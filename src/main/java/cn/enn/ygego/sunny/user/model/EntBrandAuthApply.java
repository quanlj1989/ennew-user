...
public class EntBrandAuthApply implements Serializable {
	...
	public String toString() {
		return "EntBrandAuthApply [" + "brandApplyId=" + brandApplyId+ ", memberId=" + memberId+ ", categoryId=" + categoryId+ ", categoryNamePath=" + categoryNamePath+ ", categoryIdPath=" + categoryIdPath+ ", brandName=" + brandName+ ", brandId=" + brandId+ ", status=" + status+ ", createTime=" + createTime+ ", createAcctId=" + createAcctId+ ", createMemberId=" + createMemberId+ ", createName=" + createName+ ", auditTime=" + auditTime+ ", approveDesc=" + approveDesc+ ", approveAcctId=" + approveAcctId+ ", approveMemberId=" + approveMemberId+ ", approveName=" + approveName+  "]";
	}
}
